...
interface Kpi14ResultsDisplayProps {
  result: KpiResult;
}
...
export function Kpi14ResultsDisplay({ result }: Kpi14ResultsDisplayProps) {
  return (
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Aggregate = (a)×0.4 + method×0.2 + (b)×0.4
              </p>
            </div>
          </div>
        </CardHeader>
          ...
          {result.subsetScores && (
            <div className="mt-4 rounded-lg border p-4">
              <p className="mb-3 font-semibold text-sm">
                Score Breakdown: Aggregate = (a)×0.4 + method×0.2 + (b)×0.4
              </p>

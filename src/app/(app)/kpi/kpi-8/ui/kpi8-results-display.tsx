...
interface Kpi8ResultsDisplayProps {
  result: KpiResult;
}
...
export function Kpi8ResultsDisplay({ result }: Kpi8ResultsDisplayProps) {
  return (
          ...
          {result.subsetScores && (
            <div className="mt-4 rounded-lg border p-4">
              <p className="mb-3 font-semibold text-sm">
                Score Breakdown: KPI = (a) × 0.5 + (b) × 0.5
              </p>

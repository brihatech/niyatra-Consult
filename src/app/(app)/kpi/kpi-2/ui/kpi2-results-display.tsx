...
interface Kpi2ResultsDisplayProps {
  result: KpiResult;
}
...
export function Kpi2ResultsDisplay({ result }: Kpi2ResultsDisplayProps) {
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card className="border-0 bg-card/60 shadow-lg backdrop-blur-sm">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                If result of 2.1 &quot;A&quot; = 100, KPI Score = 100; else KPI
                Score = (a) + (b)
              </p>
            </div>
          </div>
        ...
        <CardContent>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-muted-foreground text-xs">
                        Score: {ss.score.toFixed(2)} × Weight: {ss.weight} ={" "}
                        <strong>{(ss.score * ss.weight).toFixed(2)}</strong>
                      </span>
                    </div>
                  </div>
                ))}
          ...
          {/* ── Average KPI Score ─────────────────────────── */}
          <div className="mt-6 flex items-center justify-end gap-4 rounded-lg border border-blue-200 bg-blue-50/60 p-4 dark:border-blue-900 dark:bg-blue-950/20">
            <span className="font-semibold text-blue-800 text-sm dark:text-blue-300">
              Average KPI Score
            </span>
            <div

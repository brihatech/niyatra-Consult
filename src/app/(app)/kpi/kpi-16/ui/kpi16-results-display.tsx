...
interface Kpi16ResultsDisplayProps {
  result: KpiResult;
}
...
export function Kpi16ResultsDisplay({ result }: Kpi16ResultsDisplayProps) {
  return (
          ...
          {result.subsetScores && (
            <div className="mt-4 rounded-lg border p-4">
              <p className="mb-3 font-semibold text-sm">
                Score Breakdown: Aggregate Score = (a) + (b) + (c)
              </p>
